...
<head>
  ...
  <title>ARV•ENG Engenharia Elétrica</title>
  ...
  <link rel="shortcut icon" href="images/ico-arv.png" type="image/x-icon" />
  <!-- Styles -->
  <link href="style.css" rel="stylesheet">
  <link href="switcher/css/orange.css" rel="stylesheet">
  <!-- Carousel Slider -->
...
<body>
            ...
            <div class="tp-banner" >
                <ul>
                   <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <img src="images/slide/banner-slide-arv-01.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <img src="images/slide/banner-slide-arv-02.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <img src="images/slide/banner-slide-arv-04.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
	...
	<section class="white-wrapper">    	<div class="container">            <div class="services-one padding-top text-center">            	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 first">                	<div class="servicebox">                    	<a href="#">                    	<div class="service-icon">                        	<i class="fa fa-lightbulb-o fa-4x"></i>                        </div><!-- end service icon -->                        </a>                    	<div class="title">                        	<h1>INSTALAÇÕES ELÉTRICAS</h1>                        </div><!-- end title -->                        <p>Comerciais e industriais, painéis de distribuição e comando, subestações de baixa e média tensão.</p>                        <a class="readmore" href="#">saber tudo...</a>                	</div><!-- end servicebox -->                </div><!-- end col-lg-4 -->            	<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">                	<div class="servicebox">                    	<a href="#">                    	<div class="service-icon">                        	<i class="fa fa-laptop fa-4x"></i>                        </div><!-- end service icon -->                        </a>                    	<div class="title">                        	<h1>PROJETOS</h1>                        </div><!-- end title -->                        <p>Projetos para todos os tipos e instalações elétricas comerciais e industriais.</p>                        <a class="readmore" href="#">saber tudo...</a>                	</div><!-- end servicebox -->                </div><!-- end col-lg-4 -->                				<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 last">                	<div class="servicebox">                    	<a href="#">                    	<div class="service-icon">                        	<i class="fa fa-headphones fa-4x"></i>                        </div><!-- end service icon -->                        </a>                    	<div class="title">                        	<h1>MÃO-DE-OBRA</h1>                        </div><!-- end title -->                        <p>Temos uma equipe especializada e qualificada com os devidos critérios de seguraça</p>                        <a class="readmore" href="#">saber tudo...</a>                	</div><!-- end servicebox -->                </div><!-- end col-lg-4 -->            </div><!-- end services one -->		</div><!-- end container -->    </section><!-- end grey-wrapper -->    
    <section class="grey-wrapper jt-shadow nopadding" style="background-image: url(images/bg-concreto.png);">    	<div class="container">    	        	<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">    	            	<div class="widget padding-top">    	                	<h3>BEM-VINDO A<span> <b>ARV•ENG</b></span>, NOS CONHEÇA UM POUCO</h3>    	                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga. </p><br>    	                    <div id="accordion-first" class="clearfix">    	                        <div class="accordion" id="accordion2">    	                          <div class="accordion-group">    	                            <div class="accordion-heading">    	                              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSix">    	                                <em class="fa fa-plus icon-fixed-width"></em><b>MISSÃO</b>    	                              </a>    	                            </div>    	                            <div id="collapseSix" class="accordion-body collapse">    	                              <div class="accordion-inner">    	                                Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.    	                              </div>    	                            </div>    	                          </div>    	                          <div class="accordion-group">    	                            <div class="accordion-heading">    	                              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseSeven">    	                                <em class="fa fa-plus icon-fixed-width"></em><b>VISÃO</b>    	                              </a>    	                            </div>    	                            <div id="collapseSeven" class="accordion-body collapse">    	                              <div class="accordion-inner">    	                                Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.    	                              </div>    	                            </div>    	                          </div>    	    	                          <div class="accordion-group">    	                            <div class="accordion-heading">    	                              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTen">    	                                <em class="fa fa-plus icon-fixed-width"></em><b>VALORES</b>    	                              </a>    	                            </div>    	                            <div id="collapseTen" class="accordion-body collapse">    	                              <div class="accordion-inner">    	                                Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo. Manduma pindureta quium dia nois paga.    	                              </div>    	                            </div>    	                          </div>      	                        </div><!-- end accordion -->    	                    </div><!-- end accordion first -->    	                </div><!-- end widget -->    	            </div><!-- end col-lg-6 -->    	                	        	<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">    	            	<div class="wow fadeInRight margin-top">    	            	    <br/><br/><br/>    						<img class="img-responsive" src="images/sliderman_02.png" alt="">    	                </div>    				</div><!-- end col-lg-6 -->    			</div><!-- end container -->    </section>    
	<!-- end grey-wrapper -->	
	...
	<section class="white-wrapper">
		...
		<div class="portfolio_wrapper padding-top">
				...
				<div class="entry">
					<img src="images/portifolio/portfolio_01.jpg" alt="" class="img-responsive">
					<div class="magnifier">
						<div class="buttons">
							<a class="st btn btn-default" rel="bookmark" href="#">conhecer o projeto</a>
                            <h3>Subestação da Sansung</h3>
						</div><!-- end buttons -->
					</div><!-- end magnifier -->
				</div><!-- end entry -->
			</div><!-- end portfolio_item -->									<div class="portfolio_item">				<div class="entry">					<img src="images/portifolio/portfolio_02.jpg" alt="" class="img-responsive">					<div class="magnifier">						<div class="buttons">							<a class="st btn btn-default" rel="bookmark" href="#">conhecer o projeto</a>			                <h3>Subestação da Sansung</h3>						</div><!-- end buttons -->					</div><!-- end magnifier -->				</div><!-- end entry -->			</div><!-- end portfolio_item -->									<div class="portfolio_item">				<div class="entry">					<img src="images/portifolio/portfolio_03.jpg" alt="" class="img-responsive">					<div class="magnifier">						<div class="buttons">							<a class="st btn btn-default" rel="bookmark" href="#">conhecer o projeto</a>			                <h3>Subestação da Sansung</h3>						</div><!-- end buttons -->					</div><!-- end magnifier -->				</div><!-- end entry -->			</div><!-- end portfolio_item -->									<div class="portfolio_item">				<div class="entry">					<img src="images/portifolio/portfolio_04.jpg" alt="" class="img-responsive">					<div class="magnifier">						<div class="buttons">							<a class="st btn btn-default" rel="bookmark" href="#">conhecer o projeto</a>			                <h3>Subestação da Sansung</h3>						</div><!-- end buttons -->					</div><!-- end magnifier -->				</div><!-- end entry -->			</div><!-- end portfolio_item -->						

		</div><!-- portfolio_wrapper -->
		<div class="clearfix"></div>
            
		<div class="buttons padding-top text-center">
			<a href="#" class="btn btn-primary btn-lg" title="">todo portifólio</a>
		</div>
    </section><!-- end white-wrapper -->
    
	<section class="grey-wrapper jt-shadow" style="background-image: url(images/bg-concreto.png);">		<div class="container">	    	<div class="general-title">	        	<h2>ARTIGOS INTERESSANTES</h2>	            <hr>	            <p class="lead">Alguns artigos selecionados pela nossa equipe.</p>	        </div><!-- end general title -->	        	        <div class="blog-masonry">	        	            <div class="col-lg-4 first">	                <div class="blog-carousel">	                    <div class="entry">	                        <iframe class="vimeo_video" src="http://player.vimeo.com/video/72960194?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff" width="100%" height="100%"></iframe>	                        <div class="post-type">	                            <i class="fa fa-play"></i>	                        </div><!-- end pull-right -->	                    </div><!-- end entry -->	                    <div class="blog-carousel-header">	                        <h3><a title="" href="#">Título de Video</a></h3>	                        	                    </div><!-- end blog-carousel-header -->	                    <div class="blog-carousel-desc">	                        <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis.</p>	                    </div><!-- end blog-carousel-desc -->	                </div><!-- end blog-carousel -->	            </div><!-- end col-lg-4 -->		            <div class="col-lg-4">	                <div class="blog-carousel">	                    <div class="entry">							<iframe class="soundcloud" height="166"  src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/143789978&amp;color=ff5500&amp;auto_play=false&amp;hide_related=false&amp;show_artwork=true"></iframe>	                        <div class="post-type">	                            <i class="fa fa-music"></i>	                        </div><!-- end pull-right -->	                    </div><!-- end entry -->	                    <div class="blog-carousel-header">	                        <h3><a title="" href="#">Título de Áudio</a></h3>	                    </div><!-- end blog-carousel-header -->	                    <div class="blog-carousel-desc">	                        <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. </p>	                    </div><!-- end blog-carousel-desc -->	                </div><!-- end blog-carousel -->	            </div><!-- end col-lg-4 -->	            	            <div class="col-lg-4 last">	                <div class="blog-carousel">	                    <div class="entry">	                        <img src="images/blog_04.png" alt="" class="img-responsive">	                        <div class="magnifier">	                            <div class="buttons">	                                <a class="st" rel="bookmark" href="#"><i class="fa fa-link"></i></a>	                            </div><!-- end buttons -->	                        </div><!-- end magnifier -->	                        <div class="post-type">	                            <i class="fa fa-picture-o"></i>	                        </div><!-- end pull-right -->	                    </div><!-- end entry -->	                    <div class="blog-carousel-header">	                        <h3><a title="" href="#">A distorção harmônica X impactos negativos nas instalações</a></h3>	                    </div><!-- end blog-carousel-header -->	                    <div class="blog-carousel-desc">	                        <p>A correção do fator de potência no âmbito industrial é um assunto pautado como prioridade, principalmente para o atendimento aos limites impostos pela legislação...</p>	                    </div><!-- end blog-carousel-desc -->	                </div><!-- end blog-carousel -->	            </div><!-- end col-lg-4 --> 	        </div><!-- end blog-masonry -->   	    </div><!-- end container -->	</section><!-- end grey-wrapper -->

    <section class="white-wrapper">    	<div class="white-clients">        	<div class="container">                <div class="general-title">                    <h2>NOSSAS MARCAS</h2>                    <hr>                    <p class="lead">Veja as marcas de qualidade que usamos em nossos projetos </p>                </div><!-- end general title -->                        	<div class="clients padding-top text-center">                	<div class="client-wrap col-lg-3 first">                    	<a href="#" title=""><img src="images/logos/logo1.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3">                    	<a href="#" title=""><img src="images/logos/logo2.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3">                    	<a href="#" title=""><img src="images/logos/logo3.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3 last">                    	<a href="#" title=""><img src="images/logos/logo4.jpg" alt=""></a>                    </div>                </div><!-- end row -->            </div><!-- end container -->    	</div><!-- end doc -->    </section><!-- end white wrapper -->
