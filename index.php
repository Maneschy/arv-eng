...
<body>
            ...
            <div class="tp-banner" >
                <ul>
                   <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <img src="images/slide/banner-slide-arv-05.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                        <img src="images/slide/banner-slide-arv-06.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                        
                    </li>                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >                        <img src="images/slide/banner-slide-arv-07.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">                                            </li><li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >                        <img src="images/slide/banner-slide-arv-08.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">                                            </li>                    
				</ul>
	...
	<!-- end grey-wrapper -->	
    	<?php include './projetos_arv.php'; ?>
<div class="buttons padding-top text-center">	<a href="portifolio.php" class="btn btn-primary btn-lg" title="">ver portifólio</a></div>
   <hr/> 
    ...
    <section class="white-wrapper">    	<div class="white-clients">        	<div class="container">                <div class="general-title">                    <h2>ALGUNS CLIENTES</h2>                    <hr>                    <p class="lead">Veja algumas marcas que estão satisfeitas com nosso trabalho </p>                </div><!-- end general title -->                        	<div class="clients padding-top text-center">                	<div class="client-wrap col-lg-3 first">                    	<a href="#" title=""><img src="images/logos/logo-mondial.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3">                    	<a href="#" title=""><img src="images/logos/logo-marinha.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3">                    	<a href="#" title=""><img src="images/logos/logo-shopping.jpg" alt=""></a>                    </div>                	<div class="client-wrap col-lg-3 last">                    	<a href="#" title=""><img src="images/logos/logo-receita.jpg" alt=""></a>                    </div>                </div><!-- end row -->                           </div><!-- end container -->            <div class="buttons padding-top text-center">            	<a href="clientes.php" class="btn btn-primary btn-lg" title="">ver todas</a>            </div>    	</div><!-- end doc -->    </section><!-- end white wrapper -->
